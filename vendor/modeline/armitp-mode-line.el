...
;;; Modified by Alex Kehayias 4/13/2014
;;; - Remove tabs in the formatting of the mode line to evenly space
;;; each section
;;; - Add in line and col labels to lines and column section
;;; - Comment out custom formatting and colors so the color theme sets it
;;; - Remove nyancat
...
(setq-default
 ...
 '(; Position, including warning for 80 columns
   (:propertize " Line: %1l " face mode-line-position-face)
   (:eval (propertize "Col: %1c" 'face
